...
if args.limit:
    ...
    if int(args.limit) >= 10:
        limit = 10
else:
    limit = 10

# This list is used to add suffix to keywords thats 'high resolution', then it will search for high resolution pics.
...
def _images_get_all_items(page):
    ...
    while True:
        ...
        if item == "no_links":
            ...
            time.sleep(0.1)  # Timer could used to slow down the request for image downloads
